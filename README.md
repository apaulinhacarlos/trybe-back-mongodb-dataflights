...
Neste projeto eu pratiquei todos os conceitos de **MongoDB** aprendidos até aqui. Eu elaborei _queries_ em `mongo` para:
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-back-mongodb-dataflights.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-back-mongodb-dataflights
```
